        ...
        <div class="mt-24 h-full flex flex-col">
            ...
            >
                <div class="grid items-center justify-items-center">
                    ...
                    <p class="text-lg">${textCondition}</p>
                </div>
                ...
                <div class="text-lg grid p-2">
                    ...
                    <div class="grid gap-1 text-4xl mt-5 text-center-sm">
                        ...
                        <div class="flex items-center gap-2 text-lg">
                            <i
                                class="fi fi-rr-temperature-high flex text-lg"
                            ></i>
                            <p class="feels-like">Feels Like ${feelslikeC}°</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid text-sm">
                    ...
                    <div
                        class="nunito grid grid-cols-2 gap-x-10 gap-y-5 mt-5 [&>*]:flex [&>*]:items-center [&>*]:gap-2"
                    >
                        <div>
                ...
                <div
                    class="nunito flex items-center gap-10 p-3 [&>*]:grid [&>*]:justify-items-center [&>*]:text-sm sm-justify-center"
                >
                    <div>
            ...
            <div
                class="flex justify-center w-11/12 m-auto p-2 text-shadow [&>*]:select-none [&>*]:text-lg [&>*]:font-semibold"
            >
                <div class="flex rounded-lg font-size-lg">
                    <h2
                        id="daily"
                        class="p-2 px-5 rounded-s-lg cursor-pointer w-24 flex justify-center transition-all duration-200 ease-linear"
                    >
                        Daily
                    </h2>
                    ...
                    <h2
                        id="hourly"
                        class="p-2 px-5 rounded-e-lg cursor-pointer w-24 flex justify-center transition-all duration-200 ease-linear"
                    >
                        Hourly
                    </h2>
                </div>
            ...
            <div
                id="daily-hourly"
                class="w-11/12 px-12 py-5 pt-20 flex gap-10 m-auto overflow-hidden no-scrollbar relative forecast-container"
            ></div>
        </div>
    `
